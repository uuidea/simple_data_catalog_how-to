...
* xref:dcat:ROOT:dcat-intro.adoc[Data Catalog Metadata (DCAT)] - Learn comprehensive cataloging
* xref:dqv:ROOT:dqv-intro.adoc[Data Quality (DQV)] - Add quality metrics
* xref:prov:ROOT:prov-intro.adoc[Data Lineage (PROV)] - Track data provenance  
* xref:odrl:ROOT:odrl-intro.adoc[Data Policy (ODRL)] - Manage usage rights
