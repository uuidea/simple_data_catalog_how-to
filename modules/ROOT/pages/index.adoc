...
**Ready to get started?** Continue with the xref:dcat:dcat-intro.adoc[Data Catalog Metadata (DCAT)] chapter to begin building your data catalog management skills.